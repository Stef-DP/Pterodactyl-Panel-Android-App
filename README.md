...
- Opencode generated pterodactyl API documentation (as OpenAPI file) for me as the official Pterodactyl Panel documentation were shit (& AI generated) according to a moderator on their Discord server
