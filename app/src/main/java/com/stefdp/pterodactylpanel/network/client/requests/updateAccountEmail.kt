...
private const val TAG = "ClientApi[updateAccountEmail]"
...
suspend fun updateAccountEmail(
    ...
    try {
        ...
        val requestBody = UpdateAccountEmailBody(
            email = email,
            password = password,
        )

        val response = PterodactylApiClient.getClientApiService(serverUrl).updateAccountEmail(
