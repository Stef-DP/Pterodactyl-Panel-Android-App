...
private const val TAG = "ClientApi[addAccountSshKey]"
...
suspend fun addAccountSshKey(
    ...
    try {
        ...
        val requestBody = AddAccountSshKeyBody(
            name = name,
            publicKey = publicKey
        )

        val response = PterodactylApiClient.getClientApiService(serverUrl).addAccountSshKey(
