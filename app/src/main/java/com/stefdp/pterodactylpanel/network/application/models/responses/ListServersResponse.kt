...
data class ListServersResponse(
    ...
    val meta: ListServersResponseMeta
)

data class ListServersResponseMeta(
    val pagination: ListServersResponseMetaPagination
)

data class ListServersResponseMetaPagination(
    val total: Long,
    val count: Long,
    ...
    val links: ListServersResponseMetaPaginationLinks
)

data class ListServersResponseMetaPaginationLinks(
