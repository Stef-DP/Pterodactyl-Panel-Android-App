...
suspend fun downloadServerFile(
    ...
    return try {
        val downloadUrlResponse = PterodactylApiClient.getClientApiService(serverUrl).getDownloadServerFileUrl(
        ...
        val response = PterodactylApiClient.getClientApiService(serverUrl).downloadServerFile(
