...
private const val TAG = "ApplicationApi[resetServerDatabasePassword]"
...
suspend fun resetServerDatabasePassword(
    ...
    try {
        ...
        val response = PterodactylApiClient.getApplicationApiService(serverUrl).resetServerDatabasePassword(
