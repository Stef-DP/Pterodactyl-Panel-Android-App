...
private const val TAG = "ClientApi[copyServerFile]"
...
suspend fun copyServerFile(
    ...
    try {
        ...
        val requestBody = CopyServerFileBody(
            location = file
        )

        val response = PterodactylApiClient.getClientApiService(serverUrl).copyServerFile(
