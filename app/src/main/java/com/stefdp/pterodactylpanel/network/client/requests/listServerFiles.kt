...
private const val TAG = "ClientApi[listServerFiles]"

suspend fun listServerFiles(
    context: Context,
    serverId: String,
    directory: String? = null,
): Result<ListServerFilesResponse> {
    try {
        ...
        val response = PterodactylApiClient.getClientApiService(serverUrl).listServerFiles(
        ...
        if (body is ListServerFilesResponse) {
