...
private const val TAG = "ClientApi[restoreServerBackup]"
...
suspend fun restoreServerBackup(
    ...
    try {
        ...
        val requestBody = RestoreServerBackupBody(
            truncate = truncate
        )

        val response = PterodactylApiClient.getClientApiService(serverUrl).restoreServerBackup(
