...
private const val TAG = "ClientApi[sendPowerSignalToServer]"
...
suspend fun sendPowerSignalToServer(
    ...
    try {
        ...
        val requestBody = SendPowerSignalToServerBody(
            signal = signal
        )

        val response = PterodactylApiClient.getClientApiService(serverUrl).sendPowerSignalToServer(
