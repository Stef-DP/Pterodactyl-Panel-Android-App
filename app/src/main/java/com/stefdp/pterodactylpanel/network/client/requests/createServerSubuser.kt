...
private const val TAG = "ClientApi[createServerSubuser]"
...
suspend fun createServerSubuser(
    ...
    try {
        ...
        val requestBody = CreateServerSubuserBody(
            email = email,
            permissions = permissions
        )

        val response = PterodactylApiClient.getClientApiService(serverUrl).createServerSubuser(
