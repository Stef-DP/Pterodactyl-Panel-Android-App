...
private const val TAG = "ClientApi[listServerBackups]"
...
suspend fun listServerBackups(
    ...
    try {
        ...
        val response = PterodactylApiClient.getClientApiService(serverUrl).listServerBackups(
        ...
        if (body is ListServerBackupsResponse) {
