...
private const val TAG = "ApplicationApi[updateLocation]"
...
suspend fun updateLocation(
    ...
    try {
        ...
        val requestBody = CreateLocationBody(
            short = short,
            long = long
        )

        val response = PterodactylApiClient.getApplicationApiService(serverUrl).updateLocation(
