...
private const val TAG = "ClientApi[updateAccountPassword]"
...
suspend fun updateAccountPassword(
    ...
    try {
        ...
        val requestBody = UpdateAccountPasswordBody(
            currentPassword = currentPassword,
            password = password,
            passwordConfirmation = passwordConfirmation
        )

        val response = PterodactylApiClient.getClientApiService(serverUrl).updateAccountPassword(
