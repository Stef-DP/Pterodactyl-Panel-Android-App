...
private const val TAG = "ClientApi[assignAutomaticAllocationToServer]"
...
suspend fun assignAutomaticAllocationToServer(
    ...
    try {
        ...
        val response = PterodactylApiClient.getClientApiService(serverUrl).assignAutomaticAllocationToServer(
