...
private const val TAG = "ApplicationApi[getDeployableNodes]"
...
suspend fun getDeployableNodes(
    ...
    try {
        ...
        val response = PterodactylApiClient.getApplicationApiService(serverUrl).getDeployableNodes(
        ...
        if (body is GetDeployableNodesResponse) {
