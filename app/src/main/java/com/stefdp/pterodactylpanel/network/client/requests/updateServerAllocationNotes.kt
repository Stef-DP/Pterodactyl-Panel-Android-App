...
private const val TAG = "ClientApi[updateServerAllocationNotes]"
...
suspend fun updateServerAllocationNotes(
    ...
    try {
        ...
        val requestBody = UpdateServerAllocationNotesBody(
            notes = notes
        )

        val response = PterodactylApiClient.getClientApiService(serverUrl).updateServerAllocationNotes(
