...
private const val TAG = "ClientApi[updateServerDockerImage]"
...
suspend fun updateServerDockerImage(
    ...
    try {
        ...
        val requestBody = UpdateServerDockerImageBody(
            dockerImage = dockerImage
        )

        val response = PterodactylApiClient.getClientApiService(serverUrl).updateServerDockerImage(
