...
private const val TAG = "ClientApi[updateServerSchedule]"
...
suspend fun updateServerSchedule(
    ...
    try {
        ...
        val requestBody = UpdateServerScheduleBody(
        ...
        val response = PterodactylApiClient.getClientApiService(serverUrl).updateServerSchedule(
