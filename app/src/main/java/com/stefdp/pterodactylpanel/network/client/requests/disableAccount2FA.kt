...
private const val TAG = "ClientApi[disableAccount2FA]"
...
suspend fun disableAccount2FA(
    ...
    try {
        ...
        val requestBody = DisableAccount2FABody(
            password = password
        )

        val response = PterodactylApiClient.getClientApiService(serverUrl).disableAccount2FA(
