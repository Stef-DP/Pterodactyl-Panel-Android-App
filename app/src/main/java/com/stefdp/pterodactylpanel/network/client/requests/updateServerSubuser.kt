...
private const val TAG = "ClientApi[updateServerSubuser]"
...
suspend fun updateServerSubuser(
    ...
    try {
        ...
        val requestBody = UpdateServerUserBody(
            permissions = permissions
        )

        val response = PterodactylApiClient.getClientApiService(serverUrl).updateServerSubuser(
