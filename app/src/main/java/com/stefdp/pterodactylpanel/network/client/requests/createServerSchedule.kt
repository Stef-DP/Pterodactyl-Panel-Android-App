...
private const val TAG = "ClientApi[createServerSchedule]"
...
suspend fun createServerSchedule(
    ...
    try {
        ...
        val requestBody = CreateServerScheduleBody(
        ...
        val response = PterodactylApiClient.getClientApiService(serverUrl).createServerSchedule(
