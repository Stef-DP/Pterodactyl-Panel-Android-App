...
private const val TAG = "ClientApi[createServerBackup]"
...
suspend fun createServerBackup(
    ...
    try {
        ...
        val requestBody = CreateServerBackupBody(
            name = name,
            ignored = ignoredFiles,
            isLocked = isLocked
        )

        val response = PterodactylApiClient.getClientApiService(serverUrl).createServerBackup(
