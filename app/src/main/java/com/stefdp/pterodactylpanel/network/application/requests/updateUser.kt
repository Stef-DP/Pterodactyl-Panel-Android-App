...
private const val TAG = "ApplicationApi[updateUser]"
...
suspend fun updateUser(
    ...
    try {
        ...
        val requestBody = UpdateUserBody(
            email = email,
            username = username,
            firstName = firstName,
            lastName = lastName,
        ...
        val response = PterodactylApiClient.getApplicationApiService(serverUrl).updateUser(
