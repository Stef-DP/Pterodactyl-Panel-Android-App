...
private const val TAG = "ClientApi[getServerResources]"
...
suspend fun getServerResources(
    ...
    try {
        ...
        val response = PterodactylApiClient.getClientApiService(serverUrl).getServerResources(
