...
private const val TAG = "ClientApi[renameServer]"
...
suspend fun renameServer(
    ...
    try {
        ...
        val requestBody = RenameServerBody(
            name = name,
            description = description
        )

        val response = PterodactylApiClient.getClientApiService(serverUrl).renameServer(
