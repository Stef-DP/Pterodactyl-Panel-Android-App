...
import com.stefdp.pterodactylpanel.screens.client.accountsettings.components.SshKeyDisplay
import com.stefdp.pterodactylpanel.screens.client.accountsettings.tabs.sshkeys.popups.DeleteSshKeyPopup
...
fun SshKeysTab(
    ...
    viewModel: ClientAccountSettingsSshKeysTabViewModel = viewModel(),
    refreshIndex: Int
) {
