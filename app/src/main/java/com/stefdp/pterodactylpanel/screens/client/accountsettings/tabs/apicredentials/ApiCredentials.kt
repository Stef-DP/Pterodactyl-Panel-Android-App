...
import com.stefdp.pterodactylpanel.screens.client.accountsettings.components.ApiKeyDisplay
import com.stefdp.pterodactylpanel.screens.client.accountsettings.tabs.apicredentials.popups.DeleteApiKeyPopup
...
fun ApiCredentialsTab(
    ...
    viewModel: ClientAccountSettingsApiCredentialsTabViewModel = viewModel(),
    refreshIndex: Int
) {
