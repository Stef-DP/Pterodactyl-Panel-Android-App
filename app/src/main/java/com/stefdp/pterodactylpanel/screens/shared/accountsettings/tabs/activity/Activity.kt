...
import com.stefdp.pterodactylpanel.screens.shared.accountsettings.tabs.activity.popups.MetadataPopup
...
fun ActivityTab(
    ...
    viewModel: AccountSettingsActivityTabViewModel = viewModel(),
    refreshIndex: Int
) {
